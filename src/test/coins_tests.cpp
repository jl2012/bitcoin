...
{
    // Good example
    CDataStream ss1(ParseHex("97f23c835800816115944e077fe7c803cfa57f29b36bf87c1d35ff"), SER_DISK, CLIENT_VERSION);
    Coin cc1;
    ss1 >> cc1;
    ...
    // Good example
    CDataStream ss2(ParseHex("8ddf77bbd123008c988f1a4a4de2161e0f50aac7f17e7f9555caa4ff"), SER_DISK, CLIENT_VERSION);
    Coin cc2;
    ss2 >> cc2;
    ...
    CDataStream ss3(ParseHex("000006ff"), SER_DISK, CLIENT_VERSION);
    Coin cc3;
    ss3 >> cc3;
    ...
    // Good example
    CDataStream ss6(ParseHex("97f23c835800816115944e077fe7c803cfa57f29b36bf87c1d3513af4ccd20277527c9c3a7ab3ac2a93faafc2440397d07e22067632ca7856477b3"), SER_DISK, CLIENT_VERSION);
    Coin cc6;
    ss6 >> cc6;
    ...
    BOOST_CHECK_EQUAL(cc6.out.nPadShift, 19);
    BOOST_CHECK_EQUAL(HexStr(cc6.out.color), "af4ccd20277527c9c3a7ab3ac2a93faafc2440397d07e22067632ca7856477b3");

    // Good example
    CDataStream ss7(ParseHex("8ddf77bbd123008c988f1a4a4de2161e0f50aac7f17e7f9555caa4315ddea587800babed7ef7405174e86a295f131891c3f3f8af363c29f1e787c4db"), SER_DISK, CLIENT_VERSION);
    Coin cc7;
    ss7 >> cc7;
    ...
    BOOST_CHECK_EQUAL(cc7.out.nPadShift, 49);
    BOOST_CHECK_EQUAL(HexStr(cc7.out.color), "5ddea587800babed7ef7405174e86a295f131891c3f3f8af363c29f1e787c4db");

    // Incomplete color
    CDataStream ss8(ParseHex("8ddf77bbd123008c988f1a4a4de2161e0f50aac7f17e7f9555caa4315ddea587800babed7ef7405174e86a295f131891c3f3f8af363c29f1e787c4"), SER_DISK, CLIENT_VERSION);
    try {
        Coin cc8;
        ss8 >> cc8;
        BOOST_CHECK_MESSAGE(false, "We should have thrown");
