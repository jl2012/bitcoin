...
static void VerifyScriptBench(benchmark::State& state)
{
    ...
    key.Sign(SignatureHash(witScriptPubkey, txSpend, 0, SIGHASH_ALL, txCredit.vout[0], SigVersion::WITNESS_V0), witness.stack.back());
    ...
    while (state.KeepRunning()) {
        ...
        bool success = VerifyScript(
            ...
            flags,
            MutableTransactionSignatureChecker(&txSpend, 0, txCredit.vout[0]),
            &err);
