...
static void VerifyScriptBench(benchmark::State& state)
{
    ...
    PrecomputedTransactionData txdata(txSpend, 0, txCredit.vout[0].nValue);
    key.Sign(SignatureHash(witScriptPubkey, txSpend, 0, SIGHASH_ALL, SigVersion::WITNESS_V0, txdata), witness.stack.back());
