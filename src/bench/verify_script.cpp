...
static void VerifyScriptBench(benchmark::State& state)
{
    ...
    key.Sign(SignatureHash(witScriptPubkey, vscriptWitCode, txSpend, 0, SIGHASH_ALL, txCredit.vout[0].nValue, 0, SIGVERSION_WITNESS_V0), witness.stack.back(), 0);
    ...
    while (state.KeepRunning()) {
        ...
        bool success = VerifyScript(
            ...
            flags,
            MutableTransactionSignatureChecker(&txSpend, 0, txCredit.vout[0].nValue, 0),
            &err);
