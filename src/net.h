...
/** Maximum length of incoming protocol messages (no message slightly over 8 MB is currently acceptable). */
static const unsigned int MAX_PROTOCOL_MESSAGE_LENGTH = 8 * 1000 * 1000 + 1000;
