...
public:
    CMainParams() {
        ...
        base58Prefixes[WITNESS_ADDRESS] = std::vector<unsigned char>(1,25);
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[WITNESS_ADDRESS] = std::vector<unsigned char>(1,65);
...
public:
    CSegNetParams() {
        ...
        genesis = CreateGenesisBlock(1452831101, 0, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        base58Prefixes[WITNESS_ADDRESS] = std::vector<unsigned char>(1,210);
