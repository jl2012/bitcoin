...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_COLOR].bit = 6;
        consensus.vDeployments[Consensus::DEPLOYMENT_COLOR].nStartTime = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_COLOR].nTimeout = 0;
...
public:
    CRegTestParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_COLOR].bit = 6;
        consensus.vDeployments[Consensus::DEPLOYMENT_COLOR].nStartTime = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_COLOR].nTimeout = 999999999999ULL;
