...
public:
    CMainParams() {
        ...
        // Deployment of MAST (BIP114)
        consensus.vDeployments[Consensus::DEPLOYMENT_MAST].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_MAST].nStartTime = 2000000000; // Far in the future
        consensus.vDeployments[Consensus::DEPLOYMENT_MAST].nTimeout = 2100000000;
...
public:
    CSegNetParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MAST].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_MAST].nStartTime = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_MAST].nTimeout = 999999999999ULL;
