...
from .mininode import CTransaction, CTxOut, COutPoint, sha256, hash256, uint256_from_str, ser_uint256, ser_string
...
def MASTVersion0SignatureHash(pubkey, programIn, hashScriptIn, sigScriptCode, txTo, inIdx, outIdx, hashtype, amountIn, feesIn):
    ...
    hashScript = hashScriptIn if (hashtype & SIGHASHV2_KEYSCRIPTHASH) else 0
