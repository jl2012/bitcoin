...
class SegWitTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.num_nodes = 3
        self.extra_args = [["-whitelist=127.0.0.1", "-vbparams=msv0:0:0"], ["-whitelist=127.0.0.1", "-acceptnonstdtxn=0", "-vbparams=msv0:0:0"], ["-whitelist=127.0.0.1", "-vbparams=segwit:0:0", "-vbparams=msv0:0:0"]]
