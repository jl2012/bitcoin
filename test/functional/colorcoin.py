...
class ColorCoinTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        vout.append(CTxOut(0, hex_str_to_bytes("6a4d85ad00112233445566778899aabbccddeeff0123456789abcdef0123456789abcdef0001")))
        ...
        tx.vout.append(CTxOut(0, hex_str_to_bytes("6a4d85ad00112233445566778899aabbccddeeff0123456789abcdef0123456789abcdef0002")))
        self.tx_submit(tx, "bad-txns-color-in-belowout")
        tx.vout.append(CTxOut(0, hex_str_to_bytes("6a4d85ad00112233445566778899aabbccddeeff0123456789abcdef0123456789abcdef0002")))
        self.tx_submit(tx, "bad-txns-color-multiple")
        tx.vout.append(CTxOut(0, hex_str_to_bytes("6a4d85ad00112233445566778899aabbccddeeff0123456789abcdef0123456789abcdee0002")))
        self.tx_submit(tx, "bad-txns-color-multiple")
        tx.vout[4] = CTxOut(0, hex_str_to_bytes("6a4d85ad00112233445566778899aabbccddeeff0123456789abcdef0123456789abcdef0004"))
        self.tx_submit(tx, "bad-txns-color-selfassign")
        tx.vout[4] = CTxOut(0, hex_str_to_bytes("6a4d85ad00112233445566778899aabbccddeeff0123456789abcdef0123456789abcdef0080"))
        self.tx_submit(tx, "bad-txns-color-outofrange")
        tx.vout.pop()
        tx.vout.pop()
        tx.vout.pop()

        tx.vin[0].nSequence = 8388608
        color = bytes_to_hex_str(hash256(hex_str_to_bytes("0000800017a914da1745e9b549bd0bfa1a569971c77eba30cd5a4b87")))
        print (color)
        tx.vout[2] = CTxOut(0, hex_str_to_bytes("6a4d85ad" + color + "0001"))
        self.tx_submit(tx)
